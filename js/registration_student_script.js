...
//         if (fname.length < 2) {
//             document.getElementById("form_fname_student").parentElement.className+=" was-validated";
//         }else {
//             if (sname.length < 1) {
//             	document.getElementById("form_sname_student").parentElement.className+=" was-validated";
//             }else {
//                 if (uname.length < 4) {
//                 	document.getElementById("form_uname_student").parentElement.className+=" was-validated";
//                 }else {
//                     if (pass.length < 8) {
//                 		document.getElementById("form_pass_student").parentElement.className+=" was-validated";
//                     }else {
//                         if (pass != repass) {
//                             swal({
...
//                                 button: true,
//                               });
//                         	document.getElementById("form_repass_student").parentElement.className+=" was-validated";
//                         }else {
//                             if (checkbox.checked == false) {
//                             	document.getElementById("form_checkbox_student").parentElement.className+=" was-validated";
//                             }else {
//                                 swal({
...
//     document.getElementById("form_fname_student").parentElement.className+=" was-validated";
//     document.getElementById("form_sname_student").parentElement.className+=" was-validated";
//     document.getElementById("form_file1_student").parentElement.className+=" was-validated";
//     document.getElementById("form_file2_student").parentElement.className+=" was-validated";
//     document.getElementById("form_alumnus_student").parentElement.className+=" was-validated";
//     document.getElementById("form_course_student").parentElement.className+=" was-validated";
//     document.getElementById("form_address_student").parentElement.className+=" was-validated";
//     document.getElementById("form_uname_student").parentElement.className+=" was-validated";
//     document.getElementById("form_pass_student").parentElement.className+=" was-validated";
//     document.getElementById("form_repass_student").parentElement.className+=" was-validated";
//     document.getElementById("form_checkbox_student").parentElement.className+=" was-validated";
...
function submitValStudent() {
    ...
    if(document.getElementById("form_alumnus_student").checked == true){
        ...
        if(document.getElementById("form_year_student").value.length == 0){
            ...
            document.getElementById("form_year_student").style.borderColor = "green";
    ...
    if(checkbox.checked == false){
        ...
        document.getElementById("form_checkbox_student").style.borderColor = "green";
    ...
    if(address.length == 0){
        ...
        document.getElementById("form_address_student").style.borderColor = "green";
        document.getElementById("student-address-invalid").style.display = "inline";
    }
    if(course.length == 0){
        ...
        document.getElementById("form_course_student").style.borderColor = "green";
        document.getElementById("student-course-invalid").style.display = "inline";
    }
    if(file1.length == 0){
        document.getElementById("form_file1_student_case").style.borderColor = "red";
        document.getElementById("student-file1-invalid").style.display = "inline";
    }else {
        document.getElementById("form_file1_student_case").style.borderColor = "green";
    ...
    if(file2.length == 0){
        ...
        document.getElementById("student-file2-invalid").style.display = "inline";
    }else {
        document.getElementById("form_file2_student_case").style.borderColor = "green";
    ...
    if (fname.length == 0) {
        ...
        document.getElementById("form_fname_student").style.borderColor="green";
    ...
    if (sname.length == 0) {
        ...
        document.getElementById("form_sname_student").style.borderColor="green";
        document.getElementById("student-sname-invalid").style.display = "invalid";
    }
    if (uname.length == 0) {
        ...
        document.getElementById("form_uname_student").style.borderColor="green";
    ...
    if (pass.length == 0) {
        ...
        document.getElementById("form_pass_student").style.borderColor="green";
        ...
        document.getElementById("form_repass_student").style.borderColor="green";
