          ...
          <hr>
                  ...
                  <div>
                    ...
                    <br>
                      ...
                      <label for="filter_checkbox_adviser1" id="filter_label_adviser1">Von, WebsterWebsterWebsterWebster&nbsp;(10)</label>


                    <br>
                      <input type="checkbox" name="filter_checkbox_adviser2" id="filter_checkbox_adviser2">
                      <label for="filter_checkbox_adviser2" id="filter_label_adviser2">Santos, Noel noel noel&nbsp;(9)</label>

                    <br>
                      <input type="checkbox" name="filter_checkbox_adviser3" id="filter_checkbox_adviser3">
                      <label for="filter_checkbox_adviser3" id="filter_label_adviser3">Cruz, Jari jari jari jari jari&nbsp;(3)</label>
                    <br>
